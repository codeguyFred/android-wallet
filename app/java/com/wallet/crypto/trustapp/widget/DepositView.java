...
public class DepositView extends FrameLayout implements View.OnClickListener {
    ...
    private static final Uri coinbaseri = Uri.parse("https://ixx.com/trading/SP_USDT")
            .buildUpon()
...
//            .address={address}
            ...
            .build();
    private static final Uri shapeshiftUri = Uri.parse("https://www.yunjiami.com/swap/")
            .buildUpon()
